...
public class form_data_menu extends javax.swing.JFrame {

    private DefaultTableModel tabmode;
    
    private void tampil_menu(){
        Object[]baris = {"Kode Menu","Nama Menu","Harga"};
        tabmode= new DefaultTableModel(null,baris);
        table_menu.setModel(tabmode);
    }
    
    public form_data_menu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_data_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_data_menu().setVisible(true);
            }
        });
    }
